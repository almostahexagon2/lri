...
| Prefix | Meaning | Example | Meaning | Origin |
| :---- | :---- | :---- | :----- | :---- |
| rej- | To do again | rej,vidu | to see again | esperanto |
| paj- | To make | paj,muku | make food (cook)  | Toki pona “pali” |
| xaj- | To become  | xaj,sonu | become knowing  | A priori |
| mis- | To do in the wrong way | mis,lanu | misspeak | Esperanto |
...
| marked | ix sonu kjo: repuno haja zivu | A newline usally procedes the colon |

 ### Relative Clauses
 LRI does not have relative clauses because they can be easily expressed in 2 sentences or using `tje`. For examples 3 and 4, It is acceptable to use a `,` insted of `:`.  Yes, they're basically the same. Kunsi-sa would consider using `tje` to be the most "LRI like" and "proper". Brackets are only sometimes over discord for complex sentences. Evila-sa came up with brackets, but kunsi-sa sometimes uses them.
